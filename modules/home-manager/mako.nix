# A fork of the HM mako module to add a maxHistory option to make it work with Stylix
{
  config,
  lib,
  pkgs,
  ...
  options = {
    services.mako = {
      ...
      maxHistory = mkOption {
        ...
        type = types.nullOr types.int;
        description = ''
          Set maximum number of expired notification to keep in the history buffer to n.
        '';
      };
